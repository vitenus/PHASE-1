...
# Support both the recommended package structure (vitenus/) and a flat
# GitHub repository, so deployment is robust while the repository is being
# reorganized.
try:
    ...
    from scoring import economic_index, technical_feasibility_index, environmental_index, implementation_complexity_index, time_index, risk_index, ipc, ipc_band
    from economics import annual_gross_benefit, net_annual_benefit, simple_payback_months, project_roi_percent
...
decision = recommend(ipc_value,roi,payback,dcs,hurdle,reg,safety,tech,risk,market,supplier)
st.json(decision)
